          ...
          <div className="filters">
            ...
            <div className="filterSection">
              <div className="filtermap">
                ...
                <div onClick={showDate}>
                  {show ? <ExpandMoreIcon style={{color: 'rgb(31, 130, 104)'}} /> : <ExpandLessIcon style={{color: 'rgb(31, 130, 104)'}} />}
                </div>
              </div>
              {show && (
            ...
            <div className="filterSection">
              <div className="filtermap">
                ...
                <div onClick={openToggle1}>
                  {show1 ? <ExpandMoreIcon style={{color: 'rgb(31, 130, 104)'}} /> : <ExpandLessIcon style={{color: 'rgb(31, 130, 104)'}} />}
                </div>
              </div>
              {show1 && (
              ...
              <div className="workMode">
                <div className="filtermap">
                  ...
                  <div onClick={openToggle2}>
                    {show2 ? <ExpandMoreIcon style={{color: 'rgb(31, 130, 104)'}} /> : <ExpandLessIcon style={{color: 'rgb(31, 130, 104)'}} />}
                  </div>
                </div>
                <div className="boxcheck">
                  {show2 && (
              ...
              <div className="workMode">
                <div className="filtermap">
                  ...
                  <div onClick={openToggle3}>
                    {show3 ? <ExpandMoreIcon style={{color: 'rgb(31, 130, 104)'}} /> : <ExpandLessIcon style={{color: 'rgb(31, 130, 104)'}} />}
                  </div>
                </div>
                <div className="boxcheck">
                  {show3 && (
              ...
              <div className="workMode">
                <div className="filtermap">
                  ...
                  <div onClick={openToggle4}>
                    {show4 ? <ExpandMoreIcon style={{color: 'rgb(31, 130, 104)'}} /> : <ExpandLessIcon style={{color: 'rgb(31, 130, 104)'}} />}
                  </div>
                </div>
                <div className="boxcheck">
                  {show4 && (
