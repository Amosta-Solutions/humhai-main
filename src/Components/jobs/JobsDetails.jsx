        ...
        <div className="container-fluid mt-5 p-2">
          <div className="details background row">
            <div className="col-md-7">
              <div className="d-flex text-start flex-column mx-3 ">
                <h2 className="fw-semibold mt-4">{location.state.id.name}</h2>
                <h2 className="fs-5">Amosta Solution pvt ltd</h2>
                <div
                  className="mt-2 job-details"
                ...
                >
                  ...
                  <div className="left">
                    <div className="education p-2">
                      ...
                      Education: educational_requirement
                    </div>
            ...
            <div className="col-md-5 text-center my-auto mx-auto">
              <div className="text-center apply-contact-btnss mt-2">
                <div class="company-logo mt-3">
                  <img src={HumHaiLogo} alt="" className="img-fluid1" />
                </div>
                <div>
                  <button
                    className="btn button-87 btns mt-3 apply-contact-btn"
                    style={{
                      background:
                ...
                <div className="row">
                  ...
                  <div className="col-sm-12 col-md-6">
                    <p>
                      ...
                      <br />
                      <i className="fa-solid fa-caret-right me-2 text-success mb-2"></i>
                      <b>Create a responsive website</b>
                      <br />
                      <i className="fa-solid fa-caret-right me-2 text-success mb-2"></i>
                      <b>Next JS, HTML, CSS, JAVASCRICPT, MONGODB</b>
                      <br />
                    </p>
                  </div>
                  {/* ))} */}
          ...
          <div className="job-description mx-2 mt-4 row">
            <div className="col-xl-7 col-sm-12 border-end">
              ...
              Key Responsibilities: • Client Acquisition: Identify and target
              potential clients, including B2B and B2C businesses, and develop
              strategies to acquire new clients for our digital marketing
              services. • Sales Strategy: Develop and implement effective sales
              strategies to meet and exceed sales targets, including revenue and
              client acquisition goals. • Client Relationship Management: Build
              and maintain strong, long-lasting client relationships by
              understanding their needs, providing solutions, and ensuring high
              client satisfaction. • Product Knowledge: Stay up-to-date with the
              latest digital marketing trends and technologies to effectively
              communicate the value of our services to clients. • Sales
              Presentations: Prepare and deliver compelling sales presentations
              to potential clients, showcasing our digital marketing
              capabilities and the benefits of working with Qwerty Brands
              Solutions. • Sales Reporting: Track and report on sales
              performance, pipeline, and forecasts using CRM tools. • Team
              Collaboration: Collaborate with internal teams, including
              marketing, creative, and technical teams, to ensure seamless
              execution of digital marketing campaigns. Qualifications: •
              Bachelor's degree in Business, Marketing, or a related field. •
              Proven experience as a sales Manager or similar role in the
              digital marketing industry. • Strong understanding of digital
              marketing services, including SEO, PPC, social media marketing,
              content marketing, and web development. • Excellent communication,
              negotiation, and interpersonal skills. • Demonstrated ability to
              meet and exceed sales targets. • Experience with Microsoft Office
              software is a plus. • Self-motivated, results-oriented, and able
              to work independently. • Strong analytical and problem-solving
              skills. Benefits: • Competitive salary and performance-based
              incentives. • Opportunity to work with a dynamic and innovative
              team. • Ongoing training and professional development
              opportunities. Collaborative and inclusive work environment.
            </div>

            <div
              className="col-xl-5 col-sm-12 mt-4 posted-by"
