  ...
  return (
    ...
    <div className='jobs-box'>
      ...
      <div className='jobs-button'>
        ...
        <div>
          <button className='button1'><LocalLibraryIcon style={{fontSize:'18px'}}/> B.Com</button>
        </div>
        <div>
          <button className='button1'><WorkHistoryIcon style={{fontSize:'18px'}}/> 5-7 Year</button>
        </div>
