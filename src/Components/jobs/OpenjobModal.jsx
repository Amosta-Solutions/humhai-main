        ...
        <div className="open-modal">
          ...
          <div>
            <div
              ...
              style={{ width: "25%", overflowY: "scroll", height: "45%" }}
            >
              <button
                className={`w3-bar-item w3-button ${
                  activeFilter === "DatePosted" ? "active" : ""
                }`}
                onClick={() => handleFilterClick("DatePosted")}
              >
                Date posted
              </button>
              <button
                className={`w3-bar-item w3-button ${
                  activeFilter === "WorkMode" ? "active" : ""
                }`}
              ...
              <button
                className={`w3-bar-item w3-button ${
                  activeFilter === "WorkType" ? "active" : ""
                }`}
                onClick={() => handleFilterClick("WorkType")}
              >
                Work type
              </button>
              <button
                className={`w3-bar-item w3-button ${
                  activeFilter === "WorkShift" ? "active" : ""
                }`}
                onClick={() => handleFilterClick("WorkShift")}
              >
                Work shift
              </button>
              <button
                ...
                {activeFilter === "DatePosted" && (
                  <>
                    <div className="blKkOK">
                      ...
                      <label
                        htmlFor="age1"
                        style={{ margin: "auto 5px", fontSize: "18px" }}
                      >
                        All
                      </label>
                    </div>
